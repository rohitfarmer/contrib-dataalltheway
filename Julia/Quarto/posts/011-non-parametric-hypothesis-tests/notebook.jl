...
# ╔═╡ 8b188fda-6746-11ed-2818-7da19c877256
begin
	using CSV
	using Plots
...
# ╔═╡ cfe6be65-522a-4217-b4cd-cfbc93cf3a09
begin
...
# ╔═╡ 4b5e1038-f07d-4789-8086-d41b6ce6f436
md"""
...
# ╔═╡ eea1ac52-2443-4bf7-8531-266a3354e781
plot(
	data[!, :Year], 
...
# ╔═╡ 0909253c-53f8-49e1-bed4-c491b680d7e8
md"""
# Mann Whitney U Test
"""

# ╔═╡ a3696d84-f70c-4555-a849-731409c113e5
mwut_results = MannWhitneyUTest(data[!, :USA], data[!, :Canada], )

# ╔═╡ 7d202098-1226-44d3-bf5d-4b52bc9f814e
md"""
## Right tailed test
"""

# ╔═╡ aae83f1d-c715-4f87-bb90-c26c43c6a5fb
pvalue(mwut_results, tail=:right)

# ╔═╡ 509b1e9b-7604-4194-95c9-68dcdd844f41
md"""
# Wilcoxen signed-rank test
"""

# ╔═╡ f9c92711-a7bf-4b86-b643-b5020ba0fc5e
begin
...
# ╔═╡ 132b61f6-dc7e-469e-9332-381585ec454e
md"""
# Kruskal Wallis test
"""

# ╔═╡ 9be46135-ccb8-4e58-97c5-d5a9b7124329
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "c37d250ee32f12139b56924d73b3613942f2869a"
